...
public class CustomDotProgressBar extends View {
    ...
    public CustomDotProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomDotProgressBar, 0, 0);
        try {
            inactiveColor = ta.getInt(R.styleable.CustomDotProgressBar_inactiveDotColor, 0);
            activeColor = ta.getInt(R.styleable.CustomDotProgressBar_activeDotColor, 0);
            inactiveDrawable = ta.getDrawable(R.styleable.CustomDotProgressBar_inactiveDotIcon);
            activeDrawable = ta.getDrawable(R.styleable.CustomDotProgressBar_activeDotIcon);
            dotSize = ta.getDimensionPixelSize(R.styleable.CustomDotProgressBar_dotSize, 15);
            dotSpacing = ta.getDimensionPixelSize(R.styleable.CustomDotProgressBar_spacing, 15);
            maxNumDots = ta.getInt(R.styleable.CustomDotProgressBar_numberDots, 5);
            currentlyActiveDot = ta.getInt(R.styleable.CustomDotProgressBar_activeDotIndex, 0);
            cumulativeDots = ta.getBoolean(R.styleable.CustomDotProgressBar_cumulativeDots, false);
